...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'play.spelling': 'Spelling Learner',
    'play.spellingDesc': 'Build words letter by letter!',
    'play.snake': 'Word Snake',
    'play.snakeDesc': 'Eat the right words!',
    'play.board': 'Board Quest',
    'play.boardDesc': 'Roll, move & answer!',
  ...
  bn: {
    ...
    'play.spelling': 'বানান শেখা',
    'play.spellingDesc': 'অক্ষর দিয়ে শব্দ তৈরি করো!',
    'play.snake': 'শব্দ সাপ',
    'play.snakeDesc': 'সঠিক শব্দ খাও!',
    'play.board': 'বোর্ড কোয়েস্ট',
    'play.boardDesc': 'ঘুঁটি চালো ও উত্তর দাও!',
